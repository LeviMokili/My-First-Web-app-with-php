...
<div class="container">
     <div class="card mt-5 border-5 pt-2 active pb-0 px-3 ">
         <div class="card-body bg-dark ">
             ...
             <div class="row ">
             <a href="Home.php"><p><i class="fa fa-arrow-left" style="color:orange"><b> RETOUR</b></i></p></a>
                 <div class="col-12 ">
                 <?php if(!empty($avatar)) :?>
                    <img src=<?php  echo $avatar ?> alt="DP" class=" rounded-circle img-fluid " width="70" height="70">
                 <?php elseif(empty($avatar)) :?>
                    <img src=<?php echo $full_path?> width="100px" >
                 <?php endif ?>
                 
                 <p><?php echo $Bio ?></p>
                
                 <h4 class="card-title " style="color:#eef"><b><?php  echo $username ?></b></h4>
                 
                 </div>
                 <div class="col-lg-4 ">
                     <h6 class="card-subtitle mb-2 text-muted" >
                         <p class="card-text text-muted small " > <img src="https://img.icons8.com/metro/26/000000/star.png" class="mr-1 " width="19" height="19" id="star" > <span class="vl mr-2 ml-0" style="color:white"> le compte a ete creer le</span> 
                          <?php echo $created_at ?>
                            ...
                            <a href="Edit_user_profile.php?Edit_Profile=<?=  $user_id ?>">
                                            ...
                                            <button class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i><small> Modifier votre profile</small></button>
                                        
                            </a>
 <!-- Split dropright button -->
<div class="btn-group dropright"  style="border-raduis:50px">
<button type="button" class="btn btn-secondary">
 <small> Plus d'info</small>
  </button>
  ...
  <div class="dropdown-menu">
    <!-- Dropdown menu links -->
    <a class="dropdown-item" href="#"><b><i class="fa fa-phone"></i> Telephone :</b> <?php echo $phone_number ?></a>
    <a class="dropdown-item" href="#"><b>Etat Civil :</b> <?php echo $Etat_Civil  ?></a>
    <a class="dropdown-item" href="#"><b> <i class="fas fa-user-tie"></i> Profession :</b> <?php echo $profession  ?></a>
    <a class="dropdown-item" href="#"><b> <i class="fa fa-birthday-cake"></i> Aniversaire :</b> <?php echo $birthday  ?></a>
    <a class="dropdown-item" href="#"><b>Né à :</b> <?php echo $province  ?></a>
    <a class="dropdown-item" href="#"><b>Habit à :</b> <?php echo $vill_actuel  ?></a>
