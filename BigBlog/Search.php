                    ...
                    <div class="row search-body">
                        <div class="col-lg-12">
                            <div class="search-result">
                                ...
                                <div class="result-body" style="height:16px;color:orange;border-color:orange;font-family: cursive;">
                                            ...
                                            <tbody >
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                           ...
                                                           <b><a href="Single_User_Profile.php?U_ID=<?php  echo $row['user_id'] ?>"><?php echo $row['username']  ?></a></b> 
