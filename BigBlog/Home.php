        ...
        <div class="container logo-wrap">
          <div class="row pt-5">
            <div class="col-12 text-center">
              ...
              <h6 class="site-logo"><a href="Home.php" style="color:#1B4F72">CongoSharepost</a></h6><br>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <img  src="<?php echo $full_path ?>" width="100%" height="100px" onClick="triggerClick()" id="profileDisplay">
          <form action="Home.php" method="post" enctype="multipart/form-data" accept="image/gif, image/jpeg, image/jpg, image/png" id="form_submit">
               
               
                      <div class="form-group">
                        <textarea  class="form-control" name="content"   placeholder=" Write something to post "     data-emoji-picker="true" ></textarea>
                      </div>
  ...
  <script>
  constant publish = document.queryselector('#form_submit');
  form_submit.addEventListener('Add_Post',(e))=>{
    e.DefaultLoad();
  });
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) {?>
                 ...
                 <?php    
                  ...
                  ?>
                                ...
                                <?php else :?>
                                  <button type="submit" name="like" style="background:none;border:none;color:#D1D0CE"  id="like">
